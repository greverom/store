  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex flex-col md:items-start text-left w-[90%] px-0 sm:px-4 md:px-0 md:w-[85%] 
                    lg:w-[90%] md:mb-15 md:ml-0"
      >
        <motion.h1
        ...
        <motion.p
          variants={itemVariants}
          custom="left"
          className="w-[100%] md:w-34xl text-sm md:text-xl text-gray-700 mb-8 font-light mx-auto 
                    md:mx-0 pl-4 sm:pl-3 md:pl-[7%] text-left"
        >
        ...
        >
          <Link
            href="/belleza"
            className="inline-block px-8 py-3 text-sm rounded-full border border-pink-400 
                      hover:text-white hover:bg-gradient-to-r hover:from-pink-400 
                      hover:to-purple-500 hover:border-transparent transition-all duration-300 
                      ease-in-out"
          >
            Tienda
          </Link>
