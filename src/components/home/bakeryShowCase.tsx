    ...
    >
      ...
      >
        <motion.h1
          ...
          custom="left"
          className="text-5xl md:text-6xl mb-4 pl-3 sm:pl-4 md:pl-0 font-[Pacifico] bg-gradient-to-r from-amber-400 via-rose-400 to-pink-400 bg-clip-text text-transparent"
        >
          Cindy Bakery
        </motion.h1>
