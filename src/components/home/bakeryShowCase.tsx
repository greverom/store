...
export default function CindyBakeryShowcase() {
  ...
  return (
    <section
      id="dulces"
      ref={sectionRef}
       className="container mx-auto min-h-[100vh] max-w-3xl lg:max-w-full relative z-10 flex flex-col items-center justify-center text-center md:text-left pt-30 md:pt-15 gap-0"
    >
      <motion.div
        initial="hidden"
      ...
      >
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-amber-400 via-rose-400 to-pink-400 bg-clip-text text-transparent"
        >
          Cindy Bakery
        </motion.h1>
