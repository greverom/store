    ...
    <section id="nosotros" className="w-full md:py-25 min-h-[100vh] bg-gray-100 overflow-hidden">
      <div className="mx-auto py-12 px-2 pb-10 w-full max-w-[90%] sm:max-w-[80%]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-15 md:gap-12 items-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-serif font-light mb-6 text-gray-600">Sobre mí</h2>
          ...
          {/* Imágenes */}
            <motion.div
              ...
              className="relative flex flex-col md:flex-row justify-center md:block gap-12 sm:gap-10 md:mt-20"
              >
              ...
              <motion.div
                ...
                className="w-[75%] h-[160px] md:w-[275px] md:h-[180px] relative ml-auto z-10 md:-translate-y-12"
                >
                ...
                <div className="relative w-full h-full rounded-full md:rounded-full overflow-hidden shadow-lg">
                  <Image
                    src="/images/fondo belleza.jpg"
                    alt="Marca de cosméticos"
                    fill
                    sizes="(max-width: 768px) 100vw, 50vw"
                    className="object-content rounded-full md:rounded-full opacity-90 md:opacity-80"
                    priority
                  />
                </div>
              </motion.div>
              ...
              <div className="w-[75%] h-[160px] md:w-[270px] md:h-[180px]  relative mr-auto z-10 lg:translate-x-5">
